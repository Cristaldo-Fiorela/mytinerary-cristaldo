    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600" class="fullwidth" align="center" style="margin:auto">
        <tbody><tr>
            <td style="padding:30px 30px 20px 0px" class="masthead padded">
				...
				<a href="https://mytinerary-cristaldo.herokuapp.com/" style="display:block;float:left" id="logo"><img src="https://i.imgur.com/SqeCKay.png" height="130px" alt="logo" style="-ms-interpolation-mode:bicubic;display:block;border:none; text-transform:upperca;" </a>
						...
						<td style="padding:0 30px" class="padded">
							...
							<tr>
								<td style="padding:30px 0 60px 0" mc:edit="button">
									...
									<div align="left">
										<a data-qa="verification_link" href="https://mytinerary-back-cristaldo.herokuapp.com/api/verify/${string}" style="text-decoration:none;color:#FFFFFF;background-color:#FC1975;display:inline-block;padding:18px 32px;margin:auto;border-radius:34px;font-size:px;font-weight:500" class="button">
																							Verify my email
																					</a>
									</div>
